...
class Register extends React.Component {
    ...
    onSubmitSignIn = () => {
        fetch('https://smart-brain-production-9924.up.railway.app/register', {
            method: 'post',
        ...
        return(
            ...
            <div className="measure">
                ...
                <div className="mt3">
                    ...
                    <input className="pa2 input-reset ba bg-transparent hover-bg-black hover-white w-100" type="email" name="email"  id="email" onChange={this.onEmailChange}/>
                </div>
                <div className="mv3">
